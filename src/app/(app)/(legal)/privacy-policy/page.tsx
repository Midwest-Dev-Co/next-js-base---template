...
export default function PrivacyPolicy() {
    return (
        <>
            ...
            <p className="text-center text-lg leading-6 text-slate-500">
                Last updated:{' '}
                {new Date(
            ...
            <h2
                className="pt-6 text-2xl font-bold text-slate-900 sm:text-3xl"
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        {process.env.NEXT_PUBIC_COMPANY_NAME} (TSKADDRESSLINE1
            ...
            <h2 className="pt-6 text-2xl font-bold text-slate-900 sm:text-3xl">
                Children&apos;s Privacy
            </h2>
            <p>
